...
public class NumberOperations {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        Runnable task1 = () -> sumAll(numberList);
        Runnable task2 = () -> averageValue(numberList);
        Runnable task3 = () -> sumEverySecond(numberList);
    ...
    public static void sumAll(List<Integer> numberList) {
    ...
    public static void averageValue(List<Integer> numberList) {
        System.out.println(numberList.stream().mapToInt(Integer::intValue).average().getAsDouble());
    }

    public static void sumEverySecond(List<Integer> numberList) {
        System.out.println(IntStream.range(0, numberList.size()).filter(n -> n % 2 == 0).mapToObj(numberList::get).toList().stream().mapToInt(Integer::intValue).sum());
    }
